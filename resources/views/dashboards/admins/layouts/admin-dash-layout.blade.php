...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ \URL::to('/')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">News Analyzer</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <img src="dist/img/user1-128x128.jpg" class="img-circle elevation-2 admin_picture" alt="User Image">
        </div>
        <div class="info">
